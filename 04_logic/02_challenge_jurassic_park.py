...
def count_carnivore_dinosaur_egg(egg_list) -> int:
    '''
    Esta función recibe una lista de números enteros que representa la cantidad de huevos que han puesto diferentes dinosaurios en el parque jurásico y los de número par son de carnívoros. Devuelve un número con la sumna de todos los huevos de carnívoros.
    '''
...
egg_list = [3, 4, 7, 5, 8]
print(count_carnivore_dinosaur_egg(egg_list))